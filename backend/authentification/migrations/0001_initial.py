    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('parent', 'Parent'), ('medecin', 'Médecin'), ('admin', 'Administrateur')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('en_attente', 'En attente'), ('utilisee', 'Utilisée'), ('expiree', 'Expirée')], default='en_attente', max_length=20)),
                ('email_destinataire', models.EmailField(max_length=254)),
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentification.administrateur')),
            ],
        ),
    ]
